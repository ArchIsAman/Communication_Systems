...
class task2b(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.decode = decode = digital.constellation_calcdist([-1-1j, -1+1j, 1-1j, 1+1j], [0, 1, 2, 3],
        4, 1, digital.constellation.AMPLITUDE_NORMALIZATION).base()
        self.decode.set_npwr(1.0)
        self.a = a = 2
        ...
        self._a_range = qtgui.Range(0, 10, 0.1, 2, 200)
        ...
        self.digital_constellation_decoder_cb_0 = digital.constellation_decoder_cb(decode)
        ...
        self.blocks_threshold_ff_0_1 = blocks.threshold_ff((-.1), .1, 0)
        self.blocks_threshold_ff_0_0_0 = blocks.threshold_ff((-.1), .1, 0)
        ...
        self.blocks_skiphead_0 = blocks.skiphead(gr.sizeof_char*1, (100+9*6*8))
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_char*1, '/home/aryan-tamboli/EE340 - Communication Lab/Lab_8-20241023/Original_Text.txt', True, 0, 0)
        self.blocks_file_source_0.set_begin_tag(pmt.PMT_NIL)
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, '/home/aryan-tamboli/EE340 - Communication Lab/Lab_8-20241023/out2a.txt', False)
        self.blocks_file_sink_0.set_unbuffered(False)
        self.blocks_delay_0 = blocks.delay(gr.sizeof_float*1, 100)
        self.blocks_complex_to_float_0_0 = blocks.complex_to_float(1)
        self.blocks_complex_to_float_0 = blocks.complex_to_float(1)
        self.blocks_add_xx_0 = blocks.add_vff(1)
        self.analog_sig_source_x_0_1 = analog.sig_source_f((8*1e6), analog.GR_COS_WAVE, (500000 + a), 1, 0, 0)
        self.analog_sig_source_x_0_0_0_0 = analog.sig_source_f((8*1e6), analog.GR_SIN_WAVE, (500000 + a), 1, 0, 0)
        self.analog_sig_source_x_0_0_0 = analog.sig_source_f((8*1e6), analog.GR_SIN_WAVE, 500000, 1, 0, 0)
        self.analog_sig_source_x_0_0 = analog.sig_source_f((8*1e6), analog.GR_COS_WAVE, 500000, 1, 0, 0)
        self.analog_sig_source_x_0 = analog.sig_source_c(samp_rate, analog.GR_COS_WAVE, 1000, 1, 45, 0)
        ...
        self.connect((self.blocks_complex_to_float_0_0, 1), (self.blocks_multiply_xx_0_0_1, 0))
        self.connect((self.blocks_complex_to_float_0_0, 0), (self.blocks_multiply_xx_0_2, 0))
        ...
        self.connect((self.blocks_float_to_complex_0_0, 0), (self.blocks_multiply_xx_1, 1))
        ...
        self.connect((self.blocks_multiply_xx_0_2, 0), (self.blocks_add_xx_0, 0))
        self.connect((self.blocks_multiply_xx_1, 0), (self.qtgui_const_sink_x_0, 0))
        ...
        self.connect((self.blocks_threshold_ff_0_0, 0), (self.blocks_multiply_xx_0_0, 0))
        self.connect((self.blocks_threshold_ff_0_0_0, 0), (self.blocks_float_to_complex_0, 1))
        self.connect((self.blocks_threshold_ff_0_1, 0), (self.blocks_float_to_complex_0, 0))
        ...
        self.connect((self.fir_filter_xxx_0, 0), (self.blocks_threshold_ff_0_1, 0))
        ...
        self.connect((self.fir_filter_xxx_0_0, 0), (self.blocks_threshold_ff_0_0_0, 0))
        ...
        self.connect((self.rational_resampler_xxx_0_0_0, 0), (self.root_raised_cosine_filter_0_0_0, 0))
    ...
    def set_decode(self, decode):
        self.decode = decode
        self.digital_constellation_decoder_cb_0.set_constellation(self.decode)
    ...
    def set_a(self, a):
        self.a = a
        self.analog_sig_source_x_0_0_0_0.set_frequency((500000 + self.a))
        self.analog_sig_source_x_0_1.set_frequency((500000 + self.a))
