...
class task1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.blocks_threshold_ff_0_0 = blocks.threshold_ff((-.1), .1, 0)
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, '/home/aryan-tamboli/EE340 - Communication Lab/Lab_8-20241023/out1.txt', False)
        ...
        self.analog_sig_source_x_0_0 = analog.sig_source_f((8*1e6), analog.GR_SIN_WAVE, 500000, 1, 0, 0)
        self.analog_sig_source_x_0 = analog.sig_source_f((8*1e6), analog.GR_COS_WAVE, 500000, 1, 0, 0)
